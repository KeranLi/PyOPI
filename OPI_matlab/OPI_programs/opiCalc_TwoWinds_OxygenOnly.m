function opiCalc_TwoWinds_OxygenOnly(runFile)
% opiCalc_TwoWinds_OxygenOnly takes input from a run file with a
% "two-winds" solution, using d18O only for the misfit calculation,
